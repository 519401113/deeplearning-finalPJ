...
def read_imgnet(batch_size=16,valid_size=0.2,num_workers=0,pic_path='dataset'):
    data_path = pic_path
    ...
    # train_sampler = SubsetRandomSampler(train_idx)
    train_loader = torch.utils.data.DataLoader(imagenet_train, batch_size=batch_size,
        num_workers=num_workers)
    return train_loader